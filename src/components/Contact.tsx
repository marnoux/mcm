      ...
      <div className="flex flex-col gap-5 w-64">
        ...
        <div className="flex flex-col justify-center align-center">
          ...
          <a
            ...
            target="_blank"
          >
            <button className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded w-full mt-2 animateHover">
              Get directions
            </button>
          </a>
        </div>
        ...
        <a href="tel:+27823363494" target="_blank" className="flex gap-2 animateHover">
          <PhoneIcon className="align-center h-auto w-3 " /> +27 82 336 3494
        </a>
        <a
